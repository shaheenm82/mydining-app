...
public class RestaurantDataSource {
	...
	public static final String REST_COLUMN_SLOGAN = "slogan";
	private String allRestColumns[] = {REST_COLUMN_ID, REST_COLUMN_NAME, REST_COLUMN_CUISINES, REST_COLUMN_LOGOS, REST_COLUMN_SLOGAN}; 
	...
	private Restaurant getRestaurant(Cursor cursor) {
		...
		restaurant.setSlogan(cursor.getString(4));
